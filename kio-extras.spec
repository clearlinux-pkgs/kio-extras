...
Version  : 18.08.1
Release  : 7
URL      : https://github.com/KDE/kio-extras/archive/v18.08.1.tar.gz
Source0  : https://github.com/KDE/kio-extras/archive/v18.08.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536298090
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.GPLv2 %{buildroot}/usr/share/doc/kio-extras/COPYING.GPLv2
cp COPYING.LGPLv2.0 %{buildroot}/usr/share/doc/kio-extras/COPYING.LGPLv2.0
cp COPYING.LGPLv2.1 %{buildroot}/usr/share/doc/kio-extras/COPYING.LGPLv2.1
...
/usr/lib64/libmolletnetwork5.so.18.08.1
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kio-extras/COPYING.GPLv2
/usr/share/doc/kio-extras/COPYING.LGPLv2.0
/usr/share/doc/kio-extras/COPYING.LGPLv2.1
