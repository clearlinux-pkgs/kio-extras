...
%package abi
Summary: abi components for the kio-extras package.
Group: Default

%description abi
abi components for the kio-extras package.
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libkioarchive.so.5.97.0.abi
/usr/share/abi/libkioarchive.so.5.abi
/usr/share/abi/libmolletnetwork5.so.18.08.3.abi
/usr/share/abi/libmolletnetwork5.so.18.abi
...
/usr/lib64/libmolletnetwork5.so.18.08.3
