...
Version  : 18.12.1
Release  : 17
URL      : https://github.com/KDE/kio-extras/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/kio-extras/archive/v18.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547132074
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libmolletnetwork5.so.18.12.1
