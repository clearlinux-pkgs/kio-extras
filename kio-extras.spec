...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kio-extras-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kio-extras-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kio-extras-22.08.1
cd %{_builddir}/kio-extras-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662769716
mkdir -p clr-build
pushd clr-build
