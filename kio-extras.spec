...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kio-extras-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kio-extras-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kio-extras-22.12.3
cd %{_builddir}/kio-extras-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677791149
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/pt_BR/kioslave5/recentdocuments/index.cache.bz2
/usr/share/doc/HTML/pt_BR/kioslave5/recentdocuments/index.docbook
