...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kio-extras-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kio-extras-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kio-extras-23.08.2
cd %{_builddir}/kio-extras-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697254612
mkdir -p clr-build
pushd clr-build
