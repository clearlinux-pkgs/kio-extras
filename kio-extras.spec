...
Version  : 18.12.2
Release  : 18
URL      : https://github.com/KDE/kio-extras/archive/v18.12.2.tar.gz
Source0  : https://github.com/KDE/kio-extras/archive/v18.12.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549646786
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
