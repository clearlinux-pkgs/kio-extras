...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kio-extras-22.08.0.tar.xz
...
%prep
%setup -q -n kio-extras-22.08.0
cd %{_builddir}/kio-extras-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661548134
mkdir -p clr-build
pushd clr-build
